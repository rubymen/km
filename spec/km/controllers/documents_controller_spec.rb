...
describe DocumentsController, type: :controller, :versioning => true do
  ...
  describe 'GET #index' do
    ...
    it 'assign @documents' do
      expect(assigns(:documents)).to be_a(Searchkick::Results)
    end
  ...
  describe 'GET #show' do
    ...
    it 'assigns the requested user to @document' do
  ...
  describe 'PUT #update' do
    context 'with valid attributes' do
      let(:attr) { { title: 'new title', content: 'new content', description: 'new description' } }
    ...
    context 'with invalid attributes' do
      let(:attr) { { title: '', content: 'new content', description: 'new description' } }
  ...
  describe 'DELETE #destroy' do
    ...
    it 'does delete the document'  do
